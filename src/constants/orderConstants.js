...
export const ALL_SELLER_ORDERS_REQUEST = "ALL_SELLER_ORDERS_REQUEST";

export const ALL_SELLER_ORDERS_SUCCESS = "ALL_SELLER_ORDERS_SUCCESS";

export const ALL_SELLER_ORDERS_FAIL = "ALL_SELLER_ORDERS_FAIL";
